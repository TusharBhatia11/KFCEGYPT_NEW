...
public class SanityRuncases extends Utility{
	...
	@FindBy(id="com.kfc.egypt:id/rb_english") 
	WebElement EnglishLanguage;
	
	@FindBy(id="com.kfc.egypt:id/rb_arabic")
	WebElement ArabicLanguage;
	
	@FindBy(id="com.kfc.egypt:id/tv_country_code")
	WebElement CountryName;
	
	@FindBy(id="com.kfc.egypt:id/tv_change_country")
	WebElement Changecountry;
	
	@FindBy(id="com.kfc.egypt:id/tv_login")
	WebElement Login;
	
	@FindBy(id="com.kfc.egypt:id/tv_tandc")
	WebElement TermsandCondition;
	
	@FindBy(id="com.kfc.egypt:id/tv_skip_login")
	WebElement SkipLogin;
	
	@FindBy(id="com.kfc.egypt:id/tv_skip_continue")
	WebElement SkipLogin_continue;
	

	@FindBy(id="com.kfc.egypt:id/design_bottom_sheet")
	WebElement ChangecountryBottomSheet;
	
	@FindBy(id="com.kfc.egypt:id/tv_title")
	WebElement ChangecountryBottomSheetTitle;
	
	@FindBy(id="com.kfc.egypt:id/tv_des")
	WebElement ChangecountryBottomSheetDescription;
	
	
	@FindBy(xpath="//android.view.ViewGroup[@resource-id='com.kfc.egypt:id/rl_main'][1]")
	WebElement ChangecountryBottomCountryUAE;


	@FindBy(xpath="//android.view.ViewGroup[@resource-id='com.kfc.egypt:id/rl_main'][2]")
	WebElement ChangecountryBottomCountryKSA;

	@FindBy(id="com.kfc.egypt:id/tv_sub_msg")
	WebElement ChangecountryBottomCountry1Message;

	
	@FindBy(id="com.kfc.egypt:id/rb_country")
	WebElement ChangecountryBottomCountry1Radiobutton;

	@FindBy(id="com.kfc.egypt:id/btn_confirm")
	WebElement Changecountrydone;
	
	
	@FindBy(id="com.kfc.egypt:id/iv_logo")
	WebElement SplashLogo;


	@FindBy(id="com.kfc.egypt:id/tv_login_des_label")
	WebElement SplashLabelDescritpion;
	
	@FindBy(id="com.kfc.egypt:id/tv_finger_label")
	WebElement SplashLabel1;

	@FindBy(id="com.kfc.egypt:id/iv_drop_down")
	WebElement CountryDropdown;
	
	@FindBy(id="com.kfc.egypt:id/tv_country_code")
	WebElement Countrycode;
	
	@FindBy(id="com.kfc.egypt:id/et_mobile_number")
	WebElement MobileNumber;
	
	@FindBy(id="com.kfc.egypt:id/textinput_helper_text")
	WebElement MobileNumberEgText;

	@FindBy(id="com.kfc.egypt:id/bt_select")
	WebElement SubmitMobileNumber;

	@FindBy(id="com.kfc.egypt:id/tv_facebook")
	WebElement FacebookLogin;

	@FindBy(id="com.kfc.egypt:id/tv_google")
	WebElement GoogleLogin;

	@FindBy(id="com.kfc.egypt:id/tv_login_title")
	WebElement SocialLoginTitle;
	
	@FindBy(id="com.kfc.egypt:id/tv_detail")
	WebElement OTPMessage;
	
	@FindBy(id="com.kfc.egypt:id/et1")
	WebElement OTPBox1;
	
	@FindBy(id="com.kfc.egypt:id/et2")
	WebElement OTPBox2;
	
	@FindBy(id="com.kfc.egypt:id/et3")
	WebElement OTPBox3;
	
	@FindBy(id="com.kfc.egypt:id/et4")
	WebElement OTPBox4;
	
	@FindBy(id="com.kfc.egypt:id/tv_timer")
	WebElement OTPtimer;
	
	@FindBy(id="com.kfc.egypt:id/tv_resend")
	WebElement ResendOTP;
	
	@FindBy(id="com.kfc.egypt:id/bt_verify")
	WebElement VerifyOTP;
	
	@FindBy(id="com.kfc.egypt:id/et_name")
	WebElement Createprofilename;
	
	@FindBy(id="com.kfc.egypt:id/iv_flag")
	...
	@FindBy(xpath="//android.view.ViewGroup/android.widget.LinearLayout[3]/android.widget.FrameLayout/android.widget.EditText[@resource-id='com.kfc.egypt:id/et_mobile_number']")
	WebElement SocialLoginAddprofilemobilenumber;
	

	@FindBy(id="com.kfc.egypt:id/et_email")
	WebElement Createprofileemail;
	
	@FindBy(id="com.kfc.egypt:id/bt_save")
	...
	@FindBy(id="com.kfc.egypt:id/iv_menu")
	WebElement HomeBannerHamburgerMenu;
	
	@FindBy(xpath="//android.widget.TextView[@resource-id='com.kfc.egypt:id/tv_side_menu_name'][4]")
	WebElement SidemenuExploremenu;
	
	@FindBy(xpath="//android.view.ViewGroup[1]/android.view.ViewGroup[@resource-id='com.kfc.egypt:id/tv_add_to_cart']")
	WebElement MenuAddtocartP1;
	
	@FindBy(xpath="//android.view.ViewGroup[2]/android.view.ViewGroup[@resource-id='com.kfc.egypt:id/tv_add_to_cart']")
	WebElement MenuAddtocartP2;
	
	@FindBy(xpath="//android.view.ViewGroup[3]/android.view.ViewGroup[@resource-id='com.kfc.egypt:id/tv_add_to_cart']")
	WebElement MenuAddtocartP3;
	
	@FindBy(xpath="//android.view.ViewGroup[1]/android.widget.CheckBox[@resource-id='com.kfc.egypt:id/iv_fav']")
	WebElement MenuP1Favourite;
	
	@FindBy(xpath="//android.view.ViewGroup[2]/android.widget.CheckBox[@resource-id='com.kfc.egypt:id/iv_fav']")
	WebElement MenuP2Favourite;
	
	@FindBy(xpath="//android.view.ViewGroup[3]/android.widget.CheckBox[@resource-id='com.kfc.egypt:id/iv_fav']")
	WebElement MenuP3Favourite;
	

	@FindBy(id="com.kfc.egypt:id/cl_view_cart")
	...
	@FindBy(id="com.kfc.egypt:id/tv_country")
	WebElement City1stsuggesstion;
	
//	@FindBy(id="com.kfc.egypt:id/rb_pickup")
//	WebElement LocationScreenPickupoption;
//
//	@FindBy(id="com.kfc.egypt:id/rb_pickup_pickup")
//	WebElement LocationScreenPickupStore;

	@FindBy(xpath="//android.view.ViewGroup[@resource-id='com.kfc.egypt:id/et_city_auto']/android.view.ViewGroup/android.widget.EditText[@resource-id='com.kfc.egypt:id/et_auto_complete']")
...
//	WebElement LocationScreenPickupStoreCitySelect;
	...
	@FindBy(xpath="//android.view.ViewGroup[@resource-id='com.kfc.egypt:id/et_store_auto']/android.view.ViewGroup/android.widget.EditText[@resource-id='com.kfc.egypt:id/et_auto_complete']")
	WebElement LocationScreenPickupStoreState;
	
//	@FindBy(id="com.kfc.egypt:id/v_city_anchor")
//	WebElement LocationScreenPickupStoreStateselect;
	

	@FindBy(id="com.kfc.egypt:id/btn_pickup_proceed")
	WebElement LocationScreenProceed;
	
	@FindBy(id="com.kfc.egypt:id/btn_continue")
	...
	@FindBy(id="com.kfc.egypt:id/tv_store_title")
	WebElement LocationScreenPickupStoredetails;
	
	@FindBy(id="com.kfc.egypt:id/tv_name")
	WebElement CheckoutUsername;

	@FindBy(id="com.kfc.egypt:id/tv_number")
	WebElement CheckoutMobilenumber;
	

//	@FindBy(id="com.kfc.egypt:id/tv_pick_address")
//	WebElement CheckoutAddresstype;
	
	@FindBy(id="com.kfc.egypt:id/tv_address_tag")
	WebElement CheckoutAddresstag;
	
	@FindBy(id="com.kfc.egypt:id/tv_address")
	WebElement CheckoutStorename;
	
	@FindBy(id="com.kfc.egypt:id/tv_total_amount")
	WebElement CheckoutTotalAmount;

	@FindBy(id="com.kfc.egypt:id/tv_make_payment")
	...
	@FindBy(id="com.kfc.egypt:id/btn_cancel")
	WebElement PaymentwidgetCancel;
	
	@FindBy(id="com.kfc.egypt:id/btn_payment")
	WebElement PaymentMakepayment;
	
	@FindBy(id="com.kfc.egypt:id/cb_save_payment")
	WebElement PaymentSaveCheck;
	
	@FindBy(id="com.kfc.egypt:id/iv_home")
	WebElement ThanyouscreenHomeBtn;
	
	@FindBy(id="com.kfc.egypt:id/tv_status")
	WebElement ThanyouscreenOrderstatus;
	
	
	@FindBy(id="com.kfc.egypt:id/tv_grand_total_price")
	WebElement ThanyouscreenTotalPrice;
	
	@FindBy(id="com.kfc.egypt:id/tv_store_name")
	...
	@FindBy(id="com.kfc.egypt:id/iv_back")
	WebElement NooNpayBackBtn;
	
	
	@FindBy(id="com.kfc.egypt:id/tv_cl_selected_payment_option")
	WebElement CheckoutOtherPaymentOptions;
	
	@FindBy(id="com.kfc.egypt:id/tv_logout")
	WebElement profileLogout;
	
	@FindBy(id="com.kfc.egypt:id/iv_settings")
	...
	@FindBy(id="com.kfc.egypt:id/btn_proceed")
	WebElement Switchaccountproceed;
	
	@FindBy(id="com.kfc.egypt:id/btn_change_location")
	WebElement Homelocationwidgetselect;

	@FindBy(id="com.kfc.egypt:id/rb_delivery")
	...
	@FindBy(id="com.kfc.egypt:id/tv_delete_coupon")
	WebElement CartscreenDeletecoupon;
	
//	@FindBy(id="com.kfc.egypt:id/tv_current_loc")
//	WebElement Locationscreensavedaddress;

	@FindBy(id="com.kfc.egypt:id/btn_explore_menu")
	WebElement CancelTransactionCancel;
	
	@FindBy(id="com.kfc.egypt:id/tv_dismiss")
	WebElement CanceltransactionOK;
	
	@FindBy(xpath="//androidx.appcompat.app.ActionBar.Tab[1]/android.view.ViewGroup/android.widget.ImageView[@resource-id='com.kfc.egypt:id/iv_tab_image']")
	WebElement HomescreenDelivery;
	
	@FindBy(xpath="//androidx.appcompat.app.ActionBar.Tab[2]/android.view.ViewGroup/android.widget.ImageView[@resource-id='com.kfc.egypt:id/iv_tab_image']")
	WebElement HomescreenCarhop;
	
	@FindBy(xpath="//androidx.appcompat.app.ActionBar.Tab[3]/android.view.ViewGroup/android.widget.ImageView[@resource-id='com.kfc.egypt:id/iv_tab_image']")
	WebElement HomescreenPickup;
	
	@FindBy(xpath="//androidx.appcompat.app.ActionBar.Tab[4]/android.view.ViewGroup/android.widget.ImageView[@resource-id='com.kfc.egypt:id/iv_tab_image']")
	WebElement HomescreenDinein;
	
	@FindBy(xpath="//androidx.appcompat.app.ActionBar.Tab[5]/android.view.ViewGroup/android.widget.ImageView[@resource-id='com.kfc.egypt:id/iv_tab_image']")
	...
	@FindBy(id="com.kfc.egypt:id/tv_header")
	WebElement StoreofflineMsgHeadertext;
	
	@FindBy(id="com.kfc.egypt:id/tv_msg")
	...
	@FindBy(id="com.kfc.egypt:id/tv_retry")
	WebElement CheckoutErrorretry;
	
	@FindBy(id="com.kfc.egypt:id/tv_snackbar_msg")
	WebElement CheckouterrorMessage;
	
	@FindBy(id="com.kfc.egypt:id/tv_cancel")
	WebElement CheckoutErrorCancel;

	@FindBy(xpath="//android.widget.TextView[@resource-id='com.kfc.egypt:id/tv_side_menu_name'][1]")
	WebElement SidemenuTrackorder;
	
	@FindBy(id="com.kfc.egypt:id/tv_current_loc")
	WebElement SavedaddressCurrentlocation;
	
	@FindBy(id="com.kfc.egypt:id/iv_add_quantity")
	WebElement CartAddQuantity;

	@FindBy(xpath="//android.widget.TextView[@resource-id='com.kfc.egypt:id/tv_side_menu_name'][5]")
	WebElement SidemenuFeedback;
	
	@FindBy(id="com.kfc.egypt:id/tv_toolbar_title")
	WebElement FeedbackScreenTitle;

	@FindBy(id="com.kfc.egypt:id/tv_rating_msg")
	WebElement RatingTitle;

	
	@FindBy(id="com.kfc.egypt:id/rating_bar")
	WebElement Ratingstar;

	
	@FindBy(id="com.kfc.egypt:id/tv_reason_header")
	WebElement FeedbackreasonTitle;

	
	@FindBy(id="com.kfc.egypt:id/tv_select_reason")
	WebElement Reasonplaceholder;

	@FindBy(id="com.kfc.egypt:id/iv_drop_down_state")
	WebElement Reasondropdown;
	
	@FindBy(xpath="//android.widget.ListView/android.widget.LinearLayout[1]/android.widget.TextView[@resource-id='com.kfc.egypt:id/tv_reason']")
	WebElement Feedback_Reason_Payments;
	
	@FindBy(xpath="//android.widget.ListView/android.widget.LinearLayout[2]/android.widget.TextView[@resource-id='com.kfc.egypt:id/tv_reason']")
	WebElement Feedback_Reason_Offers;
	
	@FindBy(xpath="//android.widget.ListView/android.widget.LinearLayout[3]/android.widget.TextView[@resource-id='com.kfc.egypt:id/tv_reason']")
	WebElement Feedback_Reason_Location;
	
	@FindBy(xpath="//android.widget.ListView/android.widget.LinearLayout[4]/android.widget.TextView[@resource-id='com.kfc.egypt:id/tv_reason']")
	WebElement Feedback_Reason_Menu;
	
	@FindBy(xpath="//android.widget.ListView/android.widget.LinearLayout[5]/android.widget.TextView[@resource-id='com.kfc.egypt:id/tv_reason']")
	WebElement Feedback_Reason_Other;
	
	@FindBy(id="com.kfc.egypt:id/et_description")
	WebElement ReasonDescription;

	@FindBy(id="com.kfc.egypt:id/btn_send")
	WebElement FeedbackSubmit;

	@FindBy(id="com.kfc.egypt:id/tv_language")
	WebElement HomesideMenu_ArabicLanguage;

	@FindBy(id="com.kfc.egypt:id/tv_country_name")
	...
	@FindBy(xpath="//android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[2]/android.widget.TextView[@resource-id='com.kfc.egypt:id/tv_title']")
	WebElement HomeScreen_ExploremenuText;
	
	@FindBy(xpath="//android.view.ViewGroup/android.view.View[@resource-id='com.kfc.egypt:id/v']")
	...
	@FindBy(xpath="//android.widget.ScrollView/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[1]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.TextView[@resource-id='com.kfc.egypt:id/tv_country']")
	WebElement ChangecountryWidget_UAE;
	
	@FindBy(xpath="//android.widget.ScrollView/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[2]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.TextView[@resource-id='com.kfc.egypt:id/tv_country']")
	WebElement ChangecountryWidget_KSA;
	
	@FindBy(xpath="//android.widget.ScrollView/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[3]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.TextView[@resource-id='com.kfc.egypt:id/tv_country']")
	WebElement ChangecountryWidget_KWT;
	
	@FindBy(xpath="//android.widget.ScrollView/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[4]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.TextView[@resource-id='com.kfc.egypt:id/tv_country']")
	WebElement ChangecountryWidget_EGT;
	
	

	@FindBy(id="com.kfc.egypt:id/bt_cancel")
	...
	@FindBy(id="com.kfc.egypt:id/tv_edit_profile")
	WebElement EditProfile;

	@FindBy(id="com.kfc.egypt:id/tv_add_new_number")
	WebElement profileAddnewnumber;
	
	@FindBy(id="com.kfc.egypt:id/et_order_id")
	WebElement TrackorderOrderNo;
	
	@FindBy(id="com.kfc.egypt:id/btn_submit")
	WebElement TrackorderSubmit;
	
	@FindBy(id="com.kfc.egypt:id/et_country_code")
	WebElement TrackorderCountrycode;
	

	
	@FindBy(id="com.kfc.egypt:id/tv_phone")
