...
public class HomeScreen extends Utility{
	...
	@FindBy(id="com.kfc.egypt:id/tv_one")
	WebElement HomeExploremenuDeals;
	
	@FindBy(id="com.kfc.egypt:id/tv_two")
	WebElement HomeExploremenuForone;

	@FindBy(id="com.kfc.egypt:id/tv_three")
	WebElement HomeExploremenuForSharing;

	@FindBy(id="com.kfc.egypt:id/tv_four")
	WebElement HomeExploremenuSidesandDeserts;

	@FindBy(id="com.kfc.egypt:id/tv_five")
	...
	@FindBy(xpath="//android.view.ViewGroup[@resource-id='com.kfc.egypt:id/cl_image_container'][1]")
	WebElement HomescreenBanner1;
	
	@FindBy(xpath="//android.view.ViewGroup[@resource-id='com.kfc.egypt:id/cl_image_container'][2]")
