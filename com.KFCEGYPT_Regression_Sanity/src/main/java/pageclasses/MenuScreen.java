...
public class MenuScreen {
	...
	@FindBy(id="com.kfc.egypt:id/iv_search")
	WebElement MenuSearch;
	

	@FindBy(id="com.kfc.egypt:id/et_search")
	WebElement Menusearchbar;
	

	@FindBy(id="//android.widget.FrameLayout[@resource-id='com.kfc.egypt:id/fl_fav']")
	WebElement MenuFavourite;
	

	@FindBy(id="com.kfc.egypt:id/tv_customize")
	WebElement MenuCustomise;
	

	@FindBy(id="com.kfc.egypt:id/tv_edit")
