...
//	WebElement Locationscreensavedaddress;
	...
	@FindBy(id="com.kfc.egypt:id/tv_dialog_sub_header")
	...
	@FindBy(id="com.kfc.egypt:id/cb_do_not_ask")
	WebElement MakeMealDontaskagain;
	
	@FindBy(xpath="//androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[1]/android.view.ViewGroup[@resource-id='com.kfc.egypt:id/stepper_view'][1]")
